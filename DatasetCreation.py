...
address = "C:\ImportantProyects\Entrenamiento_y_Validaciones\Validaciones" #Cambiar ruta cada ve se deba agregar una nueva clase de imagen
...
while True:
    ...
    if results.multi_hand_landmarks:
        for mano in results.multi_hand_landmarks:
            ...
            dedos_reg = cv2.resize(dedos_reg, (4032,3024), interpolation=cv2.INTER_CUBIC)
            if dedos_reg.size > 0:    
